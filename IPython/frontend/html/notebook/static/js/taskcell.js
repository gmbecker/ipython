...
//              this.set_rendered(data.rendered || '');
  //              this.rendered = false;
    ...
    TaskCell.prototype = new IPython.ContainerCell();
...
/* These are now taken care of in ContainerCell
...
/* Taken care of in ContainerCell
...
//		}
    ...
    */  
    ...
    var AlternativesCell = function (kernel) {
    ...
    //    AlternativesCell.prototype = new IPython.TextCell();
    AlternativesCell.prototype = new IPython.ContainerCell();

    AlternativesCell.prototype.auto_highlight = function () {
        this._auto_highlight(IPython.config.raw_cell_highlight);
    };

    AlternativesCell.prototype.render = function () {
        this.rendered = true;
        this.edit();
    };


    AlternativesCell.prototype.set_kernel = function(kernel){
	IPython.ContainerCell.prototype.set_kernel.apply(this, arguments);
    }
  AlternativesCell.prototype.create_element = function () {
    ...
    AlternativesCell.prototype.handle_codemirror_keyevent = function (editor, event) {
        // This method gets called in CodeMirror's onKeyDown/onKeyPress
        // handlers and is used to provide custom key handling. Its return
        // value is used to determine if CodeMirror should ignore the event:
        // true = ignore, false = don't ignore.
    ...
    IPython.AlternativesCell = AlternativesCell;
